...
// function apiQuat(){
//  let apiQuat =  meaningfulQuotes.quote;

//  console.log(apiQuat);
// }

let btn = document.querySelector('.btn');
let newQuat = document.querySelector('.newQuote');
...
btn.addEventListener('click',()=>{
    let rnQuat = Math.floor(Math.random() * meaningfulQuotes.length);
    let  quote = meaningfulQuotes[rnQuat];
    newQuat.textContent = quote.quote;

    author.textContent = quote.author;
    profession.textContent = quote.profession;
    topics.textContent = quote.topics;
    console.log(quote);
});
